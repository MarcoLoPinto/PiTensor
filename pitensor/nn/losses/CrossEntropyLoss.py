...
class CrossEntropyLoss:
    """Computes the cross-entropy loss and its gradient for multi-class classification.
    """
    def forward(self, predictions: np.ndarray, targets: np.ndarray) -> float:
        ...
        Args:
            predictions (np.ndarray): Predicted probabilities for each class. Shape: (batch_size, num_classes).
